    ...
    <v-img src="../assets/heroes_adoption.png">
      <v-row>
        <v-col cols="12" sm="6" class="hidden-xs-only">
          <v-img class="il_home" src="../assets/il_home.svg"> </v-img>
        </v-col>
        <v-col cols="12" sm="6">
          <v-row class="pa-12">
            <v-container>
        ...
        <v-container>
          ...
          >
            ...
            <v-carousel-item>
              <v-row class="pa-5">
                <v-col
                  v-for="item in feed_home_respn1"
                  :key="item.id"
                  cols="12"
                  sm="4"
                >
            ...
            <v-carousel-item>
              <v-row class="pa-5">
                <v-col
                  v-for="item in feed_home_respn2"
                  :key="item.id"
                  cols="12"
                  sm="4"
                >
            ...
            <v-carousel-item>
              <v-row class="pa-5">
                <v-col
                  v-for="item in feed_home_respn3"
                  :key="item.id"
                  cols="12"
                  sm="4"
                >
        ...
        <v-col>
          <v-col>
            ...
            <v-row>
              <v-spacer></v-spacer>
              <v-col cols="12" sm="1" class="hidden-xs-only">
                <v-img src="../assets/tulang.png"> </v-img>
              </v-col>
            </v-row>
            <v-btn
              rounded
              ...
              dark
              elevation="10"
              class="btn_home_adop hidden-xs-only"
              color="#489FB5"
              to="/adoption"
            >
              Eksplore
            ...
            <v-btn
              ...
              dark
              elevation="10"
              class="btn_home_adop_res hidden-sm-and-up"
              color="#489FB5"
              to="/adoption"
            >
              Eksplore

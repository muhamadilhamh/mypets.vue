  ...
  <div class="adoption_page">
    ...
    <v-container>
      <v-row>
        ...
        <div class="search_adop">
          ...
          <v-col cols="2" md="2">
        <div class="search_adop">
            <v-select clearable rounded solo item-text="name" :items="age" item-value="value" v-model="age_selected"
    ...
    <v-container>
      <v-row>
        ...
        <v-btn @click="listToShow += 9" block>
    Load More
  </v-btn>
  ...
  export default {
    ...
    data() {
      return {
        ...
        listToShow : 9,
        age : [
          {name : '< 1 Year (New Born)', value : 1},
          {name : '1 Year - 3 Years (Teenager)', value : 3},
          {name : '3 Years - 7 Years (Adult)', value : 7},
          {name : '7 Years > (Old)', value : 7.1}
        ],
        species : null,
        search: null,
        ...
        return this.pet_list
          ...
          .filter(post => {
            if( this.age_selected != null){
              if(this.age_selected == 3){
              return  1 < post.age <= 3;
              }else if(this.age_selected == 7) {
                return  3 < post.age <= 7;
              }else if (this.age_selected > 7){
                return post.age > 7
              }else{
                return post.age < parseInt(this.age_selected)
              }
            }else {
              return post  = this.allpet_list;
            }
